...
export const EXERCISE_CATALOG: ExerciseCatalogEntry[] = [
  ...
  },
  {
    name: "相扑硬拉",
    en: "Sumo Deadlift",
    primaryMuscles: ["glute_max", "adductors", "quads"],
    secondaryMuscles: ["hamstrings", "erectors"],
    equipment: "barbell",
    pattern: "hinge",
    tips: "臀+内收肌;站距宽、脚尖外展,杠铃贴腿,髋膝同步伸展。",
  },
  {
    name: "深蹲",
    en: "Squat",
  ...
  },
  {
    ...
    secondaryMuscles: ["glute_max", "erectors", "tv_abs"],
    equipment: "barbell",
    pattern: "squat",
    tips: "股四头为主;肘抬高、躯干直立,脚跟踩稳,别让肘掉下去。",
  },
  {
    name: "高脚杯深蹲",
    en: "Goblet Squat",
    primaryMuscles: ["quads", "glute_max"],
    secondaryMuscles: ["adductors", "tv_abs"],
    equipment: "dumbbell",
    pattern: "squat",
    tips: "股四头+臀;抱哑铃或壶铃在胸前,肘在膝盖内侧,下蹲到底。",
  },
  {
    name: "保加利亚分腿蹲",
